...
import sty from "./PlasmicButton.module.css"; // plasmic-import: TUfunDceiXe8/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__jaagn, {
          [sty.freeBoxcolor_neutral__jaagnpTuM]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_warning__jaagnan0OU]: hasVariant(
            $state,
            "color",
            "warning"
          ),
          [sty.freeBoxcolor_white__jaagNmdZls]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__jaagNzSgsr]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__jaagNrlImv]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__jaagnGvKeS]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__jaagnVeGt]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__jaagnc2M3F]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__jaagn6S6Q1]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__jaagn6S6Q1H8Vk9]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__odg3K, {
            [sty.freeBoxcolor_neutral__odg3KpTuM]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__odg3KpTuMVZgte]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__odg3KuiPyr]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__odg3KrlImv]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__odg3KVeGt]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__odg3Kc2M3F]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__odg3K6S6Q1]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___0UYkU)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dUdn, {
            [sty.freeBoxiconEnd__dUdnH7I6V]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__dUdnrlImv]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__dUdnVeGt]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__dUdnC2M3F]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__pYehZ)}
                role={"img"}
              />
            ),
