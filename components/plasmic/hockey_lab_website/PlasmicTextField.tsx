...
import Label from "../../Label"; // plasmic-import: UEEpgroGNPeM/component
import TextInput from "../../TextInput"; // plasmic-import: GTvI7WpPAi-K/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: XY7k8ikP1mZU/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 5URxreujsqk7/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___6UaAz, {
          [sty.freeBoxiconEnd___6UaAZyRoi]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___6UaAzbKaQh]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___6UaAz1V56K]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__tJ8C3, {
            [sty.freeBoxiconStart__tJ8C3BKaQh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__tJ8C31V56K]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__szHP)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__pmPz9, {
            [sty.freeBoxiconEnd__pmPz9YRoi]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__pmPz9BKaQh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__tuPf1)}
                role={"img"}
              />
            ),
