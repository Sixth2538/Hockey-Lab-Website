...
import Button2 from "../../Button2"; // plasmic-import: Gn9AevL_Gj91/component
import { BasePopover } from "@plasmicpkgs/react-aria/skinny/registerPopover";
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: _QV6Qb-mj3ck/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: xkG9XGMMUCij/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__jAab8)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__w40As)}
            label={"Open Popover"}
          />
        ),
