...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Gn9AevL_Gj91/css
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__wkbD1, {
          [sty.freeBoxcolor_errorDestructive__wkbD1N3Wn4]: hasVariant(
            $state,
            "color",
            "errorDestructive"
          ),
          [sty.freeBoxcolor_muted__wkbD1ZQycu]: hasVariant(
            $state,
            "color",
            "muted"
          ),
          [sty.freeBoxcolor_neutral__wkbD11K4Ob]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success__wkbD1Xgjp]: hasVariant(
            $state,
            "color",
            "success"
          ),
          [sty.freeBoxcolor_success_type_bordered__wkbD1XgjpT475P]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_warning__wkbD16STq]: hasVariant(
            $state,
            "color",
            "warning"
          ),
          [sty.freeBoxroundedFull__wkbD1X9Gll]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__wkbD1UaPy8]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__wkbD1BdMyC]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__wkbD1USSw]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__wkbD1Bd3Xf]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__wkbD1T475P]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__smEZj, {
            [sty.freeBoxcolor_neutral__smEZj1K4Ob]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__smEZj1K4ObPXNt]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__smEZjhwGgb]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__smEZjuaPy8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__smEZjuSSw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__smEZjbd3Xf]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__smEZjt475P]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__sohkI)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__u3U19, {
            [sty.freeBoxiconEnd__u3U19QsAYy]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__u3U19UaPy8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__u3U19USSw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__u3U19Bd3Xf]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__rKeNz)}
                role={"img"}
              />
            ),
